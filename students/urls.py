...
urlpatterns = [
    ...
    path('password_change_done', auth_views.PasswordChangeDoneView.as_view(template_name='students/base.html'),
    ...
    path('send/<int:pk>/', SendRequestView.as_view(url=reverse_lazy('home')), name='send_request'),
    path('', home, name='index'),
    path('received/', received, name='received'),
    path('sent/', sent, name='sent'),
    path('accept/<uuid:pk>/', AcceptView.as_view(url=reverse_lazy('home')), name='accepted'),
    path('reject/<uuid:pk>/', RejectView.as_view(url=reverse_lazy('home')), name='reject'),
    path('cancel/<uuid:pk>/', CancelView.as_view(url=reverse_lazy('home')), name='cancel'),
